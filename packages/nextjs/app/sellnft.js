...
const [LIghthouseCid,SetLIghthouseCid] = useState('');
  ...
  formData.append('cid', LIghthouseCid)
  formData.append('endDate', endDate)
  formData.append('replicationTarget', replicationTarget)
  formData.append('epochs', epochs)

   console.log("The cid for the raas is",LIghthouseCid);
      ...
      <div className="min-h-screen py-10 bg-gradient-to-r from-green-700 to-green-300">
        ...
        <div className="container mx-auto mt-3">
          ...
          <div className="md:w-1/2 bg-black flex flex-col justify-center items-center">
            ...
            <div>
              <p className='text-justify px-4 text-white'>Congratulations on joining our thriving community! By offering your unique farm products on "Farm Hub," you're not just selling goods; you're creating opportunities for others to enjoy fresh, high-quality produce. Your participation enriches our marketplace, fostering a dynamic environment for both farmers and consumers. Thank you for being an essential part of our growing network of dedicated farmers and appreciative buyers..</p>
            </div>
          </div>
          <div className="md:w-1/2 py-10 px-12">
            ...
            <form>
              ...
              <div className="mt-5">
                <input placeholder="ITEM Price in tFIL" className="border-2 border-black rounded p-4 mb-2 w-full" onChange={(e) => updateFormInput({ ...formInput, price: e.target.value })}/>  
              </div>
            ...
            <button className="rounded-xl bg-gray-600 button mt-3" onClick={Rassjob}>
                Register RAAS JOB
							  </button>
          </div>
          </div>
