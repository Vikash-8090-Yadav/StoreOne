    ...
    <div name ="about" id ="About">
      ...
      <div className="flex flex-col md:flex-row justify-between p-5 m-10 relative sm:p-10">
        <div className="hidden lg:block">
          ...
          Our mission is to empower farmers to pursue their passions, connect with like-minded individuals, and unlock the true value of their produce within a trusted decentralized ecosystem.
          ...
          <div className="justify-between p-5 m-10 mt-72 bg-[#272D36] flex relative border rounded-[32px]">
            <div className="flex items-center 2xl:gap-20 py-10">
              ...
              <div className="flex cursor-default flex-col lg:px-8 xl:px-20">
                ...
                At "Farm HUb," we envision a global community of collectors, traders, and enthusiasts seamlessly interacting 
